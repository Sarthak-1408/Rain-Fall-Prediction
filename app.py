...
def load_model():
    result = pickle.load(open("D:/New_Project/models/xgboost_model.pkl" , "rb"))
    return result
model = load_model()
...
sunny_image = Image.open("D:/New_Project/images/sunny.jpg")
rain_image = Image.open("D:/New_Project/images/rain.jpg")
...
col19 , col20 = st.beta_columns([1,3])

profile_image = Image.open("D:/New_Project/images/profile-pic.png")
